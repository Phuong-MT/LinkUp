          ...
          >
            <div className="flex gap-2 items-center">
              <MentionTextarea
                ...
                className="w-full rounded-2xl border border-zinc-250 bg-white px-4 py-2 text-xs text-zinc-900 outline-none focus:border-blue-500 dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-100 resize-none max-h-[96px] overflow-y-auto"
              />
              <button
                type="submit"
